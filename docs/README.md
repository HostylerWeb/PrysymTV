# PrysymTV documentation

All project documentation lives under `docs/`, grouped by area.
...
Each app folder has a short README that points here:

- `api/README.md` — quick start only
- `mobile/README.md` — points to `docs/mobile/`
- `tv-projector/README.md` — points to `docs/tv-projector/`
