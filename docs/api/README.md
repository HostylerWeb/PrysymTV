...
Run guide (frontend + Docker + env): [`../web/how-to-run.md`](../web/how-to-run.md)
...
- Backend plan: [`backend-development-plan.md`](./backend-development-plan.md)
- Stakeholder / mission requirements: [`../web/stakeholder-product-requirements.md`](../web/stakeholder-product-requirements.md)

## Implementation status

Canonical route list: `./api.md` (updated with each API change).
