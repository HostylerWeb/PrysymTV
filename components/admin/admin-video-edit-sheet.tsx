...
interface AdminVideoEditSheetProps {
  videoId: string
  contentLabel: string
  isOpen: boolean
  onClose: () => void
...
export function AdminVideoEditSheet({
  videoId,
  contentLabel,
  isOpen,
  onClose,
  onSuccess,
}: AdminVideoEditSheetProps) {
      ...
      >
        <div className="flex items-center gap-3 px-5 py-4 border-b border-border shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="font-semibold text-lg">Edit {contentLabel}</h2>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-4">
          {loading && !video ? (
            ...
            <div className="py-10 text-center">
              ...
              <p className="font-semibold">{contentLabel} updated</p>
